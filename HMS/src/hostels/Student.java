...
public class Student {
    ...
    public void viewFoodMenu() {
        System.out.println("Today's menu: Rice, Dal, Roti, and Curry.");
    }
    ...
    public void viewFees(Scanner scanner) {
        hmsFees.viewFees(scanner, studentID);
    }

    public void raiseComplaints() {
        System.out.println("Complaint raised for Student ID: " + studentID);
    }
